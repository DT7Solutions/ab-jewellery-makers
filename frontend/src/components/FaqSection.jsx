...
const FAQ_DATA = [
  ...
  {
    id: 2,
    question: "Can I order custom bridal jewellery or request design modifications in Tenali?",
    answer: "Yes! We specialize in bespoke bridal jewellery made-to-order. You can share your reference photos, Pinterest ideas, or custom sketches on WhatsApp or visit our flagship boutique at Shop No. 26, ASR Complex, Beside Metro Shoemart, Gandhi Chowk, Sharaf Bazar, Tenali. Our 5th-generation hereditary goldsmiths will handcraft your dream heirloom to exact weight and design specifications."
  },
  {
    id: 3,
    question: "How are gold prices and making charges calculated for my order?",
    answer: "Our prices are calculated transparently using the live 22K Gold rate in Tenali, Andhra Pradesh. We provide itemized quotations detailing exact gross weight, stone weight, net gold weight, live gold rate, hallmarking charges, and making fees with zero hidden costs."
  },
  {
    id: 4,
    question: "What is your exchange and buyback policy for gold jewellery?",
    answer: "We offer a 100% Lifetime Exchange & Buyback Guarantee across all our hallmarked 22K gold, uncut Polki, and diamond creations. You can exchange or upgrade your heirlooms at prevailing live market rates in Tenali with zero deduction on net gold weight."
  },
  {
    id: 5,
    question: "Where is your boutique located in Tenali, and can I book a private bridal trial?",
    answer: "Our flagship jewellery boutique is located at Shop No. 26, ASR Complex, Beside Metro Shoemart, Gandhi Chowk, Sharaf Bazar, Tenali, Andhra Pradesh (PIN: 522201). We welcome brides and families for personalized in-store bridal trials and private consultations. You can also reserve a VIP trial slot directly on WhatsApp."
  },
  {
    id: 6,
  ...
  },
  {
    ...
    answer: "We accept UPI (Google Pay, PhonePe, Paytm), Credit/Debit cards, Net Banking, and Bank Wire transfers. We also accept old gold jewellery exchange at 100% live Tenali 22K market bullion value toward your new purchase with zero melting deduction."
  }
];
    ...
    <section id="faq-section" className="faq-section" aria-label="Frequently Asked Questions">
      ...
      <div className="faq-header-container">
        <div className="faq-header-center">
          ...
          <p className="section-tagline">CLEAR ANSWERS ON 22K GOLD PURITY, BESPOKE ORDERS & TENALI BOUTIQUE</p>
        </div>
      </div>
        ...
        <div className="faq-image-col">
          <div className="faq-image-frame">
            <img 
              ...
              alt="Althaf Jewellery Makers Heritage Bride - 22K Gold Jewellery in Tenali AP" 
            ...
            <div className="faq-image-overlay">
              <div className="faq-badge-content">
                ...
                <span className="faq-badge-sub">100% BIS 916 Hallmarked • Tenali, AP</span>
              </div>
            </div>
          </div>
        </div>
