export const TESTIMONIALS = [
  ...
  },
  {
    ...
    verified: true,
    comment: "100% BIS hallmarked purity and honest making charges. Their 5-generation heritage of goldsmithing is evident in every curve of their temple jewellery.",
  ...
  },
  {
    ...
    rating: 5,
    itemPurchased: "Royal Solitaire Mangalsutra",
    verified: true,
    comment: "Ordered online with fully insured delivery to Vizag. The diamond solitaire mangalsutra arrived safely in a luxury velvet box with IGI certificate and BIS hallmark.",
  ...
  },
  {
    ...
    verified: true,
    comment: "Our family has trusted Althaf Jewellery Makers for two generations. Pure gold, transparent billing, and timeless royal designs that you will never find in commercial showrooms.",
