...
import { FaWhatsapp, FaShieldAlt, FaAward, FaTruck, FaSyncAlt, FaPhoneAlt, FaChevronLeft, FaSearchPlus } from 'react-icons/fa';
          ...
          <div className="product-main-grid">
            ...
            <div className="pdp-info-column">
              ...
              <div className="pdp-price-row">
                <span className="pdp-price">{product.formattedPrice}</span>
              ...
              <div className="pdp-specs-card">
                ...
                <div className="pdp-specs-grid">
                  ...
                  <div className="pdp-spec-item">
                    ...
                    <span className="spec-val">{product.metal} ({product.purity} Gold)</span>
                  </div>
                  <div className="pdp-spec-item">
